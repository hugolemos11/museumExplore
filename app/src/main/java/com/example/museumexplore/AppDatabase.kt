...
@Database(entities = [Museum::class, ArtWork::class, TicketType::class, Event::class, Image::class, ImageArtWork::class, Category::class, User::class, Ticket::class], version = 6)
